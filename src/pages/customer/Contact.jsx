  ...
  return (
    <div className="container page-section">
      ...
      <div className="contact-layout">
        <div>
          {sent ? (
            <p style={{ color: "var(--color-accent)", fontFamily: "var(--font-mono)" }}>
        ...
        <div className="contact-info-card">
          <div className="contact-info-row">
            <div>
              <strong>Email</strong>
              <p style={{ color: "var(--color-text-muted)" }}>support@buzzed404.com</p>
            </div>
          </div>
          <div className="contact-info-row">
            <div>
              <strong>Hours</strong>
              <p style={{ color: "var(--color-text-muted)" }}>Mon–Sat, 10am–7pm IST</p>
            </div>
          </div>
          <div className="contact-info-row">
            <div>
              <strong>Studio</strong>
              <p style={{ color: "var(--color-text-muted)" }}>Buzzed.404 HQ, Bengaluru, India</p>
            </div>
          </div>
        </div>
      </div>
